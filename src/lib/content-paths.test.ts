...
describe('content-paths', () => {
  ...
  it('isUnder excludes AGENTS.md at any depth', () => {
    expect(isUnder('src/content/_wiki/AGENTS.md', '_wiki')).toBe(false);
    expect(isUnder('src/content/_wiki/pnpm/AGENTS.md', '_wiki')).toBe(false);
    expect(isUnder('src/content/_glossary/AGENTS.md', '_glossary')).toBe(false);
    expect(isUnder('src/content/_projects/AGENTS.md', '_projects')).toBe(false);
  });
});
